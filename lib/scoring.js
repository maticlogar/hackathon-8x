...
// { uri, durationMillis, targetWord, meaning, speechCode } -> { score, roast_line }
export async function scoreRecording({ uri, durationMillis, targetWord, meaning, speechCode }) {
  ...
  const attempt = async () => {
    ...
    const score = Math.round(0.7 * similarity + 0.3 * wince_rating);
