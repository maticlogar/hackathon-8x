...
// Voice IDs verified live against this ElevenLabs account's plan — several
// premade/library voices 402 on this free-tier key, these two don't.
export const ELEVENLABS_VOICE_IDS = {
  sl: 'pNInz6obpgDQGcFmaJgB', // Adam
  de: 'EXAVITQu4vr4xnSDxMaL', // Bella
};
